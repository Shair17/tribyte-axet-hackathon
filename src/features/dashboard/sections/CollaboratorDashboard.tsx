...
export default function CollaboratorDashboard({
  ...
  const vacationData = {
    ...
    suggestedConsumptionWindow: "2024-12-31",
  };
  const consumptionPercentage =
    (vacationData.consumed / vacationData.total) * 100;

  const recentVacations = [
    {
      period: "Dec 20-27, 2024",
      days: 7,
      status: "Completed",
      location: "Remote",
    },
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Current year allocation and consumption
              </CardDescription>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-muted-foreground">
                {consumptionPercentage.toFixed(0)}% used
              </span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <p className="font-semibold">
                {new Date(
                  vacationData.accumulationStartDate,
            ...
            <div className="space-y-1">
              ...
              <p className="font-semibold">
                {vacationData.suggestedConsumptionWindow}
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-amber-50 border border-amber-200">
              ...
              <div className="flex-1">
                <p className="font-semibold text-sm text-amber-900">
                  Running low on vacation days
                </p>
                <p className="text-xs text-amber-700 mt-1">
                  You have {vacationData.remaining} days remaining. Consider
                  planning your time off before the year ends.
                </p>
              </div>
            </div>
          )}
