...
export function AdministratorDashboard({ user }: AdministratorDashboardProps) {
  const systemStats = {
    totalUsers: 248,
    activeUsers: 234,
    leaders: 12,
  ...
  const aiInsights = [
    {
      ...
      description:
        "3 employees have overlapping vacation and medical leave records",
      count: 3,
      action: "Review Now",
    },
    {
  ...
  const recentActivity = [
    ...
    {
      action: "System integration synced",
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-base mt-1">
                Full platform overview and control • {user.email}
              </CardDescription>
            </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xs text-muted-foreground">Managing teams</div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {aiInsights.map((insight, index) => (
              <div
                key={index}
                className={`p-4 rounded-lg border-2 ${getAlertColor(insight.type)}`}
              >
                <div className="flex items-start gap-3">
                  <div className="mt-0.5">{getAlertIcon(insight.type)}</div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-4 text-sm">
                        ...
                        <div
                          className={`font-semibold ${alertColors[dept.alertLevel as keyof typeof alertColors]}`}
                        >
